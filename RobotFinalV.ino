...
const unsigned long runTimeLimit = 10000;

const int encoderPPR = 800;
...
char bluetoothCommand = '0'; // Default to STOP
...
void setup() {
  ...
  pressServo.write(restAngle);

  // Serial setup
  Serial.begin(9600);   // For USB Serial Monitor
  Serial1.begin(9600);  // For Bluetooth on pins 18/19 (TX1/RX1)
